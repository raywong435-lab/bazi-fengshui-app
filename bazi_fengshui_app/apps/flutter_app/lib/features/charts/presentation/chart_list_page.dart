...
class _ChartListItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final createdAtText =
        DateFormat('yyyy-MM-dd HH:mm').format(chart.createdAt);
    final timeZoneText = chart.timeZone ?? 'Local';
    final genderText = _formatGender(chart.gender);
